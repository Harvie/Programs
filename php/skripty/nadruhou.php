...
$zero = 0;      //Zero line
$stop = 6;      //Last X
$step = 0.5;    //0.1 //Increase X on every line by this number
$reset = 50; //When X >= reset, then it will be reseted to zero
...
$width = 2;     //20 //35 //40 //This will stretch every line.
